...
<?php
    ...
    $stmt->execute();
    foreach ($stmt as $row) {
        echo template1('index_template.html',$row["id"],$row["name"],$row["descs"] );
    }
?>
<html>
    <head>
    ...
    <body background="img\bac.png">
        <div class=title>
            <h2>更新履歴</h2>
            <p>
            2021/09/10 ファイル構造を変更、アカウント作成、ログイン機能が復活(ただしOP25Bによりメール認証が届かない)。<br>
            2021/09/08 鯖を自宅に移行。OP25B問題のためアカウント作成、ログイン機能が停止中。<br>
        ...
        <div id=top align="center">
            <div class=title>
                ...
                if(isset($_SESSION['auth'])){
                    ...
                    echo '<h3><a href="login?e=0">ログイン</a>もしくは<a href="create_ac?e=0">アカウント作成</a></h3>';
                }
                ?>
            </div>
        </div>
